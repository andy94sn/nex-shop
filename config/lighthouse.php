    ...
    */
    ...
    'route' => [
        ...
        'middleware' => [
            ...
            // Token-based session: reads X-Session-Token header (or generates one).
            // Replaces cookie-based session for API / GraphQL playground clients.
            \Modules\Core\Http\Middleware\TokenSessionMiddleware::class,

            // Sets the application locale from session → X-Locale header → Accept-Language.
            // Must run AFTER TokenSessionMiddleware so the session is already started.
